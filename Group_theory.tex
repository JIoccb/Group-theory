...
\begin{document}
        ...
        \begin{proof}
          ...
          \
            \begin{enumerate}
              ...
              \end{equation*}
              Таким образом, ${\phi i_g \phi^{-1} \in \Inn(G) \Rightarrow \Inn(G) \triangleleft \Aut(G).}$
	...
	\end{proof}
        ...
        \end{remark}
        \begin{exmpl*}
            ${G = S_n \Rightarrow [\sigma, \tau] = \sigma \tau \sigma^{-1} \tau^{-1}}$~--- чётная ${\Rightarrow G' \leqslant A_n.}$ С другой стороны, $A_n$ порождается тройными циклами, которые, в свою очередь, представимы как коммутаторы:
            \begin{equation*}
		  \begin{gathered}
        ...
        \begin{exmpls}
            ...
            \begin{enumerate}
                ...
                \item ${S_n \curvearrowright \{1,\mathellipsis, n\}, \ i \mapsto \sigma(i)}.$ \n
                Действие транзитивно и эффективно, но не свободно при $n \geqslant 3$, т.к. ${St(i) \cong S_{n-1}.}$ 
                \item ${\sigma \in S_n, \ G = \langle \sigma \rangle \curvearrowright \{1,\mathellipsis, n\} = X.}$\n
